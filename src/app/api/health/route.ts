  ...
  return NextResponse.json(
    {
      ...
      endpoints: {
        ...
        "GET /api/og": "Dynamic OG image — 1200×630 DNA Certificate PNG for single wallet",
        "GET /api/og-compare": "Dynamic OG image — 1200×630 comparison card showing two wallets side by side",
